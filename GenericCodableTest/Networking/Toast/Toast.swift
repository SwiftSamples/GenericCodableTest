...
public extension UIView {
    ...
    private func createToastActivityView() -> UIView {
     ...
     //   let activityView = UIView(frame: CGRect(x: 0.0, y: 0.0, width: 100, height: 80))
...
//        let imageName = "icon1000"
//        let image = UIImage(named: imageName)
//        let imageView = UIImageView(image: image!)
//
//        imageView.frame = CGRect(x: -20, y: activityIndicatorView.bounds.height - 57, width: 80, height: 40)
//        
...
public struct ToastStyle {
     ...
     */
    public var cornerRadius: CGFloat = 22.5;
    
    /**
     The title font. Default is `.boldSystemFont(16.0)`.
     */
    public var titleFont: UIFont = UIFont(name: "Cairo-Bold", size: 16) ?? .boldSystemFont(ofSize: 16.0)
    
    /**
     The message font. Default is `.systemFont(ofSize: 16.0)`.
     */
    public var messageFont: UIFont = UIFont(name: "Cairo-Regular", size: 16) ?? .systemFont(ofSize: 16.0)
     ...
     */
    public var activitySize = CGSize(width:45.0, height:45.0)
     ...
     */
    public var activityBackgroundColor: UIColor = .black
